...
This card convert RGB TTL (xRGB / TTLLS from some Apple IIe cards) to "standard" RGB. Color are not exactly the same as the Apple IIe color palette but is usable.  
